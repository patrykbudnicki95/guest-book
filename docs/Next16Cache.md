Currently Next 16 introduces cache components. We want to follow pattern of that approach in this project. To be sure that you have access to the latest docs according this pattern, I'm pasting docs from next below:
...
Defer rendering to request time by wrapping components in React's <Suspense>, showing fallback UI until the content is ready, or
...
{/_ <p>Loading..</p> is part of the static shell _/}
...
params - Dynamic route parameters (unless at least one sample is provided via generateStaticParams). See Dynamic Routes with Cache Components for detailed patterns.
page.tsx
...
return (
<>
{/_ Static content - prerendered automatically _/}
<header>
<h1>Our Blog</h1>
<nav>
